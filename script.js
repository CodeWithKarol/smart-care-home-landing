...
function initMobileMenu() {
	...
	if (hamburger) {
		// Use a named function for the event handler to avoid anonymous function duplication issues if needed,
		// but for now, simple addEventListener is fine as we only call init once.
		// Removing the cloneNode complexity as it can be problematic.
...
document.addEventListener(
	...
	function () {
		console.log(
			"Initializing SmartCare Home Landing Page..."
		);
